...
GaitParams state_gait_params[] = {
    ...
    {26.3, 0.00, 15.70, 3.00, 0.1, 1.0}, // WALK AHEAD boung test

    {16.0, 8.00, 5.00, 0.00, 0.30, 1.2}, // WALK BACK


    {23.0, 10.00, 3, 2.00, 0.20, 2.0}, // ROTATE LEFT
//    {23.0, 10.0, 4.00, 2.00, 0.25, 2.2}, // ROTATE RIGHT
    {23.0, 10.00, 3, 2.00, 0.20, 2.0},

    {NAN, NAN, NAN, NAN, NAN, NAN}, // WALK LEFT
    {NAN, NAN, NAN, NAN, NAN, NAN}, // WALK RIGHT
...
//        {17.5, 14.00, 4, 0.00, 0.25, 2.3}
        ...
        {20.5, 14.00, 4, 0.00, 0.25, 2.3},
        {20.5, 14.00, 4, 0.00, 0.25, 2.3}
    },

    {   // TEST5
        {23.0, 18.00, 6, 1.00, 0.25, 2.2},
        {23.0, 18.00, 6, 1.00, 0.25, 2.2},

        {16.0, 10.00, 3, 1.00, 0.25, 2.2},
        {16.0, 10.00, 3, 1.00, 0.25,2.2},
    },

    {   // TEST6
        {28.0, 6.00, 3, 0.00, 0.25, 2.3},
        {28.0, 6.00, 3, 0.00, 0.25,2.3},
    ...
    {   //CLIMBING	爬坡	前腿降低 后腿抬高
        {16.0, 12.00, 5.0, 0.00, 0.40, 5.0},
        {16.0, 12.00, 5.0, 0.00, 0.40, 5.0},
        {26.0, 12.00, 5.0, 0.00, 0.40, 5.0},
        {26.0, 12.00, 5.0, 0.00, 0.40, 5.0}
    },

    {   //WALK AHEAD TEST
        {26.0, 25.00, 15.2, 0.00, 0.22, 0.2},
        {26.0, 25.00, 15.2, 0.00, 0.22, 0.2},
...
//        _Roll_rev=_Roll_initial-imuinfo.ActVal[2];
        ...
        case WALK_AHEAD:		//前进
            ...
            //gait_detached(detached_params, 0.0, 0.25, 0.75, 0.5, 1.0, 1.0, 1.0, 1.0);
            break;
...
void gait_detached(	DetachedParam d_params,
    ...
    float t = times/1000.0-now_time/1000.0;
